      ...
      <section id="contact" className="section container">
        ...
        <div className="contact-section-grid">
          ...
          <div className="contact-info">
            <p>I'm currently available for freelance projects and full-time frontend roles. If you have a question or just want to say hi, my inbox is always open!</p>
            
            <div className="contact-links" style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <a href="mailto:Kelvinatsu213@gmail.com" className="btn btn-outline" style={{ justifyContent: 'flex-start' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                <span>Kelvinatsu213@gmail.com</span>
              </a>
